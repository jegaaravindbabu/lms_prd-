  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // so per-tenant branding can recolor the whole UI at runtime.
        ...
        // Luxe brand accent (the tenant primaryColor), exposed as raw channels.
        brand: {
      ...
      boxShadow: {
        luxe: "0 1px 0 0 hsl(0 0% 100% / 0.04) inset, 0 20px 50px -20px hsl(240 40% 4% / 0.6), 0 8px 20px -12px hsl(240 40% 4% / 0.5)",
        "luxe-sm": "0 1px 0 0 hsl(0 0% 100% / 0.05) inset, 0 10px 30px -14px hsl(240 40% 4% / 0.55)",
